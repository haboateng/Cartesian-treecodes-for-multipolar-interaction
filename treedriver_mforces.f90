...
! EXECUTABLE STATEMENTS
      ...
      ALLOCATE(tenergy(numpars),denergy(numpars),&
               ...
               tfx(numpars),tfy(numpars),tfz(numpars),STAT=err)
      IF (err .NE. 0) THEN
...
! Calling main subroutine to approximate the energy
      ...
      CALL TREECODE(x,y,z,mpole,numpars,mporder,mpdim,tenergy,tpeng,tfx,tfy,tfz,&
