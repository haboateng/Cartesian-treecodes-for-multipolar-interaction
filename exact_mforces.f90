...
! EXECUTABLE STATEMENTS
      ...
      CALL DIRECT_ENG_FRC(x,y,z,mpole,numpars,mpdim,denergy,&
                      fxx,fyy,fzz,dpeng)
      ...
      DEALLOCATE(x,y,z,mpole,denergy,fxx,fyy,fzz)
...
!!!!!!!!!!!!!!
      ...
      SUBROUTINE DIRECT_ENG_FRC(x,y,z,mpole,numpars,mpdim,denergy,&
                            fxx,fyy,fzz,dpeng) 
...
! local variables 
      ...
      DO i=1,numpars-1!numpars
         ...
         DO j=i+1,numpars 
            ...
            jmp1=mpole(j,1);jmp2=mpole(j,2);jmp3=mpole(j,3);jmp4=mpole(j,4);jmp5=mpole(j,5);jmp6=mpole(j,6)
            jmp7=mpole(j,7);jmp8=mpole(j,8);jmp9=mpole(j,9);jmp10=mpole(j,10) 
...
! compute recurrence terms
            ...
            teng=teng+jmp1*rr+rr3*(jmp2*xx+jmp3*yy+jmp4*zz)-rr3*(jmp5+jmp8+jmp10)+&
